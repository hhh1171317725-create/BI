...
- 大航海的“项目”维度可导入创量优化团队人效 CSV，或粘贴 `cls.mobgi.com/download/report/` 下载链接/完整 curl。系统会按日期和项目名称关联创意、消耗、展示、点击、转化及成本数据；优化师、时间和任务维度不关联这些字段。常见项目别名会自动归一，例如“闲鱼”对应“淘宝闲鱼促活”，“淘宝营销CVR”对应“淘宝促购CVR”。
