...
(() => {
  ...
  dialog.innerHTML=`<header class="bid-dialog-head"><h2 id="endedWarningsTitle">已结束赔付期预警</h2><button type="button" class="dialog-close" aria-label="关闭过期预警">×</button></header>
    ...
    <p class="ended-warning-status" role="status" aria-live="polite"></p><div class="bid-dialog-body"><div class="ended-warning-table"><table><thead><tr><th>计划 / 账户</th><th>赔付期结束</th><th>累计消耗</th><th>最低消耗</th><th>累计转化</th><th>还差转化</th><th>核验范围</th></tr></thead><tbody></tbody></table></div></div>
